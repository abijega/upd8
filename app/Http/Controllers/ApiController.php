...
class ApiController extends Controller
{
    ...
    public function getCliente($id) {
        if (Cliente::where('id', $id)->exists()) {
            ...
            return response()->json(["message" => "Ops!! Cliente não encontrado!!!"], 404);
        }
    }
    ...
    public function updateCliente(ClienteRequest $request, $id) {
        if (Cliente::where('id', $id)->exists()) {
            ...
            return response()->json(["message" => "Ops! Cliente não localizado!!!"], 404);
    ...
    public function getEstado($id) {
        if (Estado::where('id', $id)->exists()) {
            ...
            return response()->json(["message" => "Ops!! Estado não encontrado!!!"], 404);
        }
    }
    ...
    public function getCidade($id) {
        if (Cidade::where('id', $id)->exists()) {
            ...
            return response()->json(["message" => "Ops!! Cidade não encontrada!!!"], 404);
        }
    }
    ...
    public function getAllCidadeEstado($id) {
        if (Cidade::where('estado_id', $id)->exists()) {
            ...
            return response()->json(["message" => "Ops!! Cidades não encontradas para este estado!!!"], 404);
        }
    }
